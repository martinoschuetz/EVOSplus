 ...
 * pvm integrated
 *
 * Revision 1.5  1995/02/06  08:14:08  schuetz
 * GUI version
 *
 * Revision 1.4  1994/06/07  08:17:20  schuetz
 * stdio.h include deleted
 *
 * Revision 1.4  1994/06/07  08:17:20  schuetz
 * stdio.h include deleted
 *
     ...
     int long_only;
{
  ...
  if (longopts != NULL
	  ...
	  ))
    {
      ...
      int indfound = 0; /* Not sure for this initialization. */
